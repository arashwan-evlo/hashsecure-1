   ...
   //dd($products);
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $product->product_custom_field1 = !empty($product_details['product_custom_field1'])?$product_details['product_custom_field1']:'';
            $product->product_custom_field2 = !empty($product_details['product_custom_field2'])?$product_details['product_custom_field2']:'';
            $product->product_custom_field3 = !empty($product_details['product_custom_field3'])?$product_details['product_custom_field3']:'';
            $product->product_custom_field4 = !empty($product_details['product_custom_field4'])?$product_details['product_custom_field4']:'';
    ...
    public function getProducts()
    {
        if (request()->ajax()) {
            ...
            if (in_array('weighing_scale_barcode', $search_fields)) {
                $weighing_barcode =$search_term;
                ...
                if ($product_details['success']) {
                    ...
                    $search_term=$product_details['sku'];
                }
            }
    ...
    private function __parseWeighingBarcode($scale_barcode)
    {
        ...
        if ((strlen($scale_setting['label_prefix']) == 0) || Str::startsWith($scale_barcode, $scale_setting['label_prefix'])) {
            ...
            //dd($scale_barcode,$scale_setting,$sku,$qty_int,$qty_decimal);
