        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($category)
                ...
                ->editColumn('image',function ($row){
                    return '  <a href="/uploads/media/' . $row->image . '" style="display: flex;"><img src="/uploads/media/' . $row->image . '" alt="Product image" class="product-thumbnail-small"></a >';
                })
                ->removeColumn('id')
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($request->hasFile('image')) {
                ...
                $uploaded_file = Media::uploadFile($file_name);

                if (!empty($category->image) && file_exists(public_path('/uploads/media/'.$category->image))) {
                    unlink(public_path('/uploads/media/'.$category->image));
                }
