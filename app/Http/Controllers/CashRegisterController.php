...
class CashRegisterController extends Controller
{
    ...
    public function show($id)
    {
        ...
        /*ToDO :get funde transafer 17-1-2023*/

        $fund_transfer = FundTransfer::where('business_id', $business_id)
            ->select([
                DB::raw('SUM(account_from_amount) as total_fund_from'),
                DB::raw('SUM(account_to_amount) as total_fund_to'),
                DB::raw('SUM(account_from_amount-account_to_amount) as total_fund'),
            ])
        ...
        return view('cash_register.register_details')
                    ->with(compact('fund_transfer','register_details', 'details', 'total_expences','sells_return','sells','purchases_returns','expenses','purchases','payment_types', 'close_time','payements_detail'));
    }
    ...
    public function getRegisterDetails()
    {
        ...
        $details = $this->cashRegisterUtil->getRegisterTransactionDetailscategory($user_id, $open_time, $close_time, $is_types_of_service_enabled);
    ...
    public function getCloseRegister($id = null)
    {
        ...
        return view('cash_register.close_register_modal')
                    ->with(compact('fund_transfer','register_details','total_expences','sells_return','sells','purchases_returns','expenses','purchases','details', 'payment_types', 'close_time','payements_detail'));
    }
