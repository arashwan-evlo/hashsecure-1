$(document).ready(function() {
    ...
    transfare_products = $('#transfare_products').DataTable({
        processing: true,
        serverSide: true,
        aaSorting: [[0, 'desc']],
        ajax: '/stock-transfers/transfare_products',
        columnDefs: [
            {
                targets: 8,
                orderable: false,
        ...
        columns: [
            { data: 'transaction_date', name: 'transaction_date' },
            { data: 'ref_no', name: 'ref_no' },
            { data: 'batch_number', name: 'ts1.batch_number' },
            { data: 'name', name: 'products.name' },
            { data: 'quantity_in', name: 'quantity_in', "searchable": false },
