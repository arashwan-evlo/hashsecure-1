	...
	<div class="box box-solid">
		<div class="box-body">
			<div class="row">
				...
				<div class="col-md-3">
					<div class="form-group">
						{!! Form::label('extra_cost_type','نوع التكلفة') !!}
						{!! Form::select('extra_cost_type',['0'=>'نسبة مئوية','1'=>'قيمة ثابتة'],!empty($recipe->extra_cost_type) ? $recipe->extra_cost_type : 0, ['class' => 'form-control ' ]); !!}
					...
					<div class="form-group">
						...
						<div class="input-group">
							@php
								...
								if($recipe->extra_cost_type==0){
									$final_price = $final_price + ($final_price * $recipe->extra_cost / 100);
								}else{
								$final_price = $final_price + $recipe->extra_cost ;
