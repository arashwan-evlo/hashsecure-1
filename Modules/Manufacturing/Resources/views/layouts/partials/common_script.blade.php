<script type="text/javascript">
	$(document).ready( function () {
	        ...
	        ajax: {
	            ...
	            data: function(d) {
                    if($('#date_range').val()) {
                        ...
                        d.start_date = start;
                        d.end_date = end;
                        d.mfg_is_final=$('#mfg_is_final').val();
                    }
	            },
	        },
	        columnDefs: [
        ...
        $(document).on('change','#mfg_is_final',function () {
            productions_table.ajax.reload();
        });
    ...
    $(document).on('change', '.quantity, .row_sub_unit_id, #total_quantity, #extra_cost,#extra_cost_type, #sub_unit_id', function(){
