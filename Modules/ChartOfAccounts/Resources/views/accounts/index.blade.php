                ...
                @component('components.widget', ['class' => 'box-primary', 'title' => __('chartofaccounts::lang.chart_view')])
                    ...
                    <div class="row">
                        ...
                        {{-- <div class="clearfix"></div>
                         <div class="col-md-3">
                        <div class="box-tools" style="max-width: 120px">
                            <button type="button" class="btn btn-block btn-primary btn-modal-add"
                         ...
                         <div class="col-md-3">
                            <div class="box-tools" style="max-width: 120px">
                                <button type="button" class="btn btn-block btn-primary btn-modal-edit"
                                        data-href="{{action('\Modules\ChartOfAccounts\Http\Controllers\ChartOfAccountsController@addacount')}}"
                                        data-container=".brands_modal">
                                    <i class="fa fa-plus"></i> @lang( 'messages.edit' )</button>
                            </div>
                        </div>--}}
                    </div>
