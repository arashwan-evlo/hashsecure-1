            ...
            @component('components.widget', ['class' => 'box-primary', 'title' => __('chartofaccounts::lang.payment_receipt')])
               <div class="row">
                ...
                <div class="dt-buttons btn-group">
                    ...
                    href="{{action('\Modules\ChartOfAccounts\Http\Controllers\JournalController@payment_receipt_add')}}"
                       >

                        <span><i class="fas fa-plus-circle fa-lg" aria-hidden="true"></i> @lang( 'messages.add' ) @lang(('chartofaccounts::lang.payment_receipt')) </span>
                    </a>
...
@section('javascript')
            ...
            <script>
             ...
             function getdata() {
                 $.ajax({
                     url: '{{action("\Modules\ChartOfAccounts\Http\Controllers\JournalController@get_payment_receipt")}}',
                     method: "GET",
                      data: {
