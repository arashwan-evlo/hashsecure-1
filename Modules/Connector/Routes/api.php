...
Route::middleware('auth:api', 'timezone')->prefix('connector/api')->group(function () {
    ...
    Route::post('slide', 'Modules\Connector\Http\Controllers\Api\CategoryController@media');
    ...
    Route::resource('categories', 'Modules\Connector\Http\Controllers\Api\CategoryController')->only('index', 'show');
    ...
    Route::post('user/login', [Modules\Connector\Http\Controllers\Api\UserController::class, 'login']);
    ...
    Route::get('governorate', [Modules\Connector\Http\Controllers\Api\GovernorateController::class, 'index']);



    /* Site Order */

    Route::post('/neworder',[Modules\Connector\Http\Controllers\Api\TransactionController::class,'create']);
...
Route::get('/attendance',[Modules\Connector\Http\Controllers\Api\EssenttialsController::class,'get_attendce']);
Route::post('/set_attendance',[Modules\Connector\Http\Controllers\Api\EssenttialsController::class,'set_attendance']);
});
