...
class ProductController extends ApiController
{
 ...
 public function getahmeddata()
 {
    ...
    public function index()
    {
       $user = Auth::user();
        ...
        $products=Product::where('products.business_id',$business_id)
             ...
             ->select('var.id','products.name','products.image','products.product_description'
    ...
    public function index_old()
    {
        ...
        $filters = request()->only([ 'category_id', 'location_id', 'per_page']);
    ...
    public function show($product_ids)
    {
       ...
       $products=Product::where('products.business_id',$business_id)
        ...
        ->select('products.id','products.name','products.image','products.product_description'
            , DB::raw("CONCAT('" . asset('uploads/media') . "/', products.image) AS image_url")
            ,'categories.id as cat_id','categories.name as cat_name','categories.description as cat_desc'
            ,DB::raw("SUM(qty_available) as stock")
            ,'var.sell_price_inc_tax as price','default_sales_discount'
    ...
    private function __getProducts($business_id, $filters = [], $search = [], $pagination = false, $order_by = null, $order_direction = null)
    {
        ...
        $with = [ 'unit', 'category', 'product_variations.variations.media', 'product_locations'];
