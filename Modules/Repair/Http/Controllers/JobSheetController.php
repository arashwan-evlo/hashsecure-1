            ...
            return DataTables::of($job_sheets)
                ->addColumn('action', function($row) {
                    ...
                    if (auth()->user()->can("job_sheet.view_assigned") || auth()->user()->can("job_sheet.view_all") || auth()->user()->can("job_sheet.create")) {
                            $html .= '<li>
                                <a href="' . action('\Modules\Repair\Http\Controllers\JobSheetController@show', ['job_sheet' => $row->id]) . '" class="cursor-pointer">
                                    <i class="fa fa-eye"></i>
                                    '.__("messages.view").'
                                </a>
                                </li>
                    ...
                    if (auth()->user()->can("job_sheet.edit")) {
                        $html .= '<li>
                                    <a href="' . action('\Modules\Repair\Http\Controllers\JobSheetController@edit', ['job_sheet' => $row->id]) . '" class="cursor-pointer edit_job_sheet">
...
*/
                ...
                ->editColumn('status', function($row) {
                    $html = '<a data-href="' . action("\Modules\Repair\Http\Controllers\JobSheetController@editStatus", ['id'=>$row->id]) . '" class="edit_job_sheet_status cursor-pointer" data-orig-value="'.$row->status.'" data-status-name="'.$row->status.'">
