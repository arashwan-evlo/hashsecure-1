                ...
                ->addColumn(
                    ...
                    function ($row) {
                        ...
                        if (auth()->user()->can("repair.view") || auth()->user()->can("direct_sell.access")) {
                            $html .= '<li><a href="#" data-href="' . action("\Modules\Repair\Http\Controllers\RepairController@show", ['repair' => $row->id]) . '" class="btn-modal" data-container=".view_modal"><i class="fas fa-eye" aria-hidden="true"></i> ' . __("messages.view") . '</a></li>';
                        }
                ...
                ->addColumn('total_remaining', function ($row) {
                 ...
                 ->editColumn('job_sheet_no', function($row) {
                    ...
                    if (!empty($row->job_sheet_id)
                        && (auth()->user()->can("job_sheet.view_assigned") || auth()->user()->can("job_sheet.view_all") || auth()->user()->can("job_sheet.create"))) {
