...
class DataController extends Controller
{
    ...
    public function user_permissions()
    {
        return [
            [
                'value' => 'inventory.stocking_module', // which in database
                'label' =>  __('inventory::lang.stocking_module'), // use lang file in Resurces\lang\..... lang name\lang.php user value in 'creat'=>' sdhsdhsdhsdgs',
                'default' => false
            ],
