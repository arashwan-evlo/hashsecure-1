...
/*End of get products */
    ...
    public function stocking_old(Request $request)
    {
        $business_id = request()->session()->get('user.business_id');
        $transaction_id=$request->id;
        $transaction=InventoryTransactions::where('inventory_transactions.id',$transaction_id)
   ...
   try{
    ...
    public function savestocking(Request $request){
        ...
        $inventory_id=$request->transaction_id;
        $location_id=$request->location_id;
        $variation_id=$request->variation_id;
        ...
        $unit_price=$request->unit_price;
         $log_msg="";
          $inventory_transaction=InventoryTransactions::where('id',$inventory_id)->first();
          $transaction_id=$inventory_transaction->transaction_id;
          if($transaction_id==0){
              $transaction_id=$this->createtransaction($inventory_transaction);
          }
        ...
        try{
            ...
            if(!$exist){
                ...
                $log_msg="إضافة جرد";
                    ...
                    $exist->transaction_id=$inventory_id;
    ...
    public function createtransaction($inventory){
        $business_id = request()->session()->get('user.business_id');
        ...
        $data['status']='';
        $data['is_quotation']='0';
        $data['adjustment_type']='normal';
        $data['ref_no']='SA2022/0007';
        $data['transaction_date']=$inventory->transaction_date;
        $data['total_before_tax']='0';
        $data['tax_amount']='0';
        $data['discount_amount']='0';
        $data['rp_redeemed']='0';
        $data['rp_redeemed_amount']='0';
        $data['shipping_charges']='0';
        $data['is_export']='0';
        $data['round_off_amount']='0';
        $data['additional_expense_value_1']='0';
        $data['additional_expense_value_2']='0';
        $data['additional_expense_value_3']='0';
        $data['additional_expense_value_4']='0';
        $data['final_total']='0';
        $data['is_direct_sale']='0';
        $data['is_suspend']='0';
        $data['exchange_rate']='1';
        $data['total_amount_recovered']='0';
        $data['created_by']=$user_id;
        $data['repair_updates_notif']='0';
        $data['mfg_production_cost']='0';
        $data['mfg_production_cost_type']='percentage';
        $data['mfg_is_final']='0';
        $data['essentials_duration']='0';
        $data['essentials_amount_per_unit_duration']='0';
        $data['is_created_from_api']='0';
        $data['rp_earned']='0';
        $data['is_recurring']='0';
