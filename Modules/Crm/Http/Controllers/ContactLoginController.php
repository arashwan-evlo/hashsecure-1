                    ...
                    ->addColumn('action', function ($row) {
                        $html = '<div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-left" role="menu">
                                        <li>
                                            <a data-href="' . action('\Modules\Crm\Http\Controllers\ContactLoginController@edit', [ $row->id, 'crm_contact_id' => $row->crm_contact_id]) . '" class="cursor-pointer edit_contact_login">
                                                <i class="fa fa-edit"></i>
                                                '.__("messages.edit").'
                                            </a>
                                        </li>
                                        <li>
                                            <a data-href="' . action('\Modules\Crm\Http\Controllers\ContactLoginController@destroy', [ $row->id, 'crm_contact_id' => $row->crm_contact_id]) . '"  id="delete_contact_login" class="cursor-pointer">
