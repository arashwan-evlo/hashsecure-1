    ...
    <div class="row">
        ...
        <div class="col-xs-6">
            <div class="form-group">
                ...
                {!! Form::number('grace_before_checkin', !empty($settings['grace_before_checkin']) ? $settings['grace_before_checkin'] : null, ['class' => 'form-control','step' => 1]); !!}
        ...
        <div class="col-xs-6">
            <div class="form-group">
                ...
                {!! Form::number('grace_after_checkin', !empty($settings['grace_after_checkin']) ? $settings['grace_after_checkin'] : null, ['class' => 'form-control', 'step' => 1]); !!}
        ...
        <div class="col-xs-6">
            <div class="form-group">
                ...
                {!! Form::number('grace_before_checkout', !empty($settings['grace_before_checkout']) ? $settings['grace_before_checkout'] : null, ['class' => 'form-control', 'step' => 1]); !!}
        ...
        <div class="col-xs-6">
            <div class="form-group">
                ...
                {!! Form::number('grace_after_checkout', !empty($settings['grace_after_checkout']) ? $settings['grace_after_checkout'] : null, ['class' => 'form-control', 'step' => 1]); !!}
                <p class="help-block">@lang('essentials::lang.grace_before_checkin_help')</p>
            </div>
        </div>
    </div>
