    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="form-group">
                        {!! Form::label('totallpre',' مدفوعات سابقة:') !!}
                        {!! Form::text('totallpre',$data->paid_value, ['class' => 'form-control decimal ', 'readonly' ]); !!}
                ...
                <div class="col-lg-4">
                    <div class="form-group">
                        ...
                        {!! Form::text('totallpaid',$latfines_value+$data->benefit_value+$data->installment_value-$data->paid_value, ['class' => 'form-control decimal intallparameter', 'required','id'=>'totallpaid' ]); !!}
                        {!! Form::hidden('totallreq',$latfines_value+$data->benefit_value+$data->installment_value-$data->paid_value, ['class' => 'form-control decimal intallparameter', 'id'=>'totallreq' ]); !!}
...
$(document).on('keyup','#latfines',function () {
    ...
    var totallpre=$('#totallpre').val();

    var total=(installment_value*1+benefit_value*1+latfines*1-totallpre*1).toFixed(2);
