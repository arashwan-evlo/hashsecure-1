            ...
            return Datatables::of($transactions)
                        ->addColumn('action', function ($row) {
                            ...
                            if ($row->payment_status != "paid") {
                                $html .= '<li>
                                    <a href="' . action('TransactionPaymentController@addPayment', [$row->id]) . '" class="add_payment_modal">
                            ...
                            $html .= '
                                    ...
                                    <li>
                                        <a data-href="' . action('\Modules\Project\Http\Controllers\InvoiceController@show', [$row->id,'project_id'=>$row->pjt_project_id]) . '" class="cursor-pointer view_a_project_invoice">
                                            <i class="fa fa-eye"></i>
                                            '.__("messages.view").'
                                        </a>
                                    </li>
                                    <li>
                                        <a href="' . action('\Modules\Project\Http\Controllers\InvoiceController@edit', [$row->id,'project_id'=> $row->pjt_project_id]) . '" class="cursor-pointer edit_a_invoice">
                                            <i class="fa fa-edit"></i>
                                            '.__("messages.edit").'
                                        </a>
                                    </li>
                                    <li>
                                        <a data-href="' . action('\Modules\Project\Http\Controllers\InvoiceController@destroy', [$row->id,'project_id'=> $row->pjt_project_id]) . '" class="cursor-pointer delete_a_invoice">
                ...
                ->editColumn('invoice_no', '
                            <a data-href="{{action("\Modules\Project\Http\Controllers\InvoiceController@show", [$id, $pjt_project_id])}}" class="cursor-pointer view_a_project_invoice text-black">
                                {{$invoice_no}}
                            </a>
                        ')
