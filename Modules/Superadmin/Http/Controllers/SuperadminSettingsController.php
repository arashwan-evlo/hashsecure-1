...
class SuperadminSettingsController extends BaseController
{
    ...
    public function edit()
    {
        ...
        $packages=Package::where('price','=',0)-> pluck('name','id');
        $default_package=env('DEFULT_PACKAGE',null);
         return view('superadmin::superadmin_settings.edit')
            ->with(compact(
                ...
                'default_values',
                'backup_disk',
                'cron_job_command','packages','default_package'
            ));
    }
    ...
    public function update(Request $request)
    {
        ...
        try {
            ...
            $env_settings =  $request->only(['APP_NAME', 'APP_TITLE',
                ...
                'FLUTTERWAVE_SECRET_KEY', 'FLUTTERWAVE_ENCRYPTION_KEY', 'MAPBOX_ACCESS_TOKEN','DEFULT_PACKAGE'
            ]);
