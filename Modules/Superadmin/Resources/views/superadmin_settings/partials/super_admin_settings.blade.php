<div class="pos-tab-content active">
    <div class="row">
        ...
        <div class="col-xs-4">
            <div class="form-group">
                {!! Form::label('DEFULT_PACKAGE', __('superadmin::lang.default_package') . ':') !!}
                <div class="input-group">
                <span class="input-group-addon">
                    <i class="fa fa-exclamation-triangle"></i>
                </span>
                    {!! Form::select('DEFULT_PACKAGE', $packages,$default_package, ['class' => 'form-control select2','placeholder' => __('superadmin::lang.select_default_package')]); !!}
                </div>
            </div>
        </div>
