              ...
              <div class="row check_group">
                 ...
                 <div class="col-md-9">
                  ...
                  <div class="col-md-12">
                      <div class="checkbox">
                          <label>
                              {!! Form::checkbox('selected_accounts', 'access_all_accounts', false,
                            ['class' => 'input-icheck check_all']); !!} السماح بخزن محددة للدفع و التحصيل
                          </label>
                  ...
                  @foreach($accounts as $location)
                      <div class="col-md-12">
                          <div class="checkbox">
                              <label>
                                  {!! Form::checkbox('account_permissions[]', $location->id, false,
                                  [ 'class' => 'input-icheck check_account']); !!} {{ $location->name }}
                              </label>
                          </div>
                      </div>
                  @endforeach
...
<script type="text/javascript">
  ...
  $(document).on('ifChecked','.check_account',function (){
      var checked=0;
      $(this)
          .closest('.check_group')
          .find('.check_all')
