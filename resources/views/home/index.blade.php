...
@section('content')
    ...
    <div style="background-color: white;width: 95%; margin: auto;margin-top: 20px;
            ...
            <a href="{{action('ContactController@index', ['type' => 'supplier'])}}" class="cont" >
             ...
             @endcan
              @can('stock_report.view')
               <div class="col-lg-2 col-md-4 col-sm-6 col-xs-6">
                <a href="{{action('ReportController@getStockReport')}}" class="cont" >
        ...
        <br>
        @can('dashboard.data')
          <div class="row"  style="background-color:#ffffff;margin-bottom: 7px">
                                    ...
                                    <div class="info-box-content">
                                        ...
                                        <table >
                                            ...
                                            <tr>
                                                ...
                                                <td><span class="info-box-number total_purchase_month"><i class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span></td>
                                            </tr>
                                            <tr>
                                                <td></span><span class="total-labels">السنة  : </span></td>
                                                <td><span class="info-box-number total_purchase_year"><i class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span></td>
                                            </tr>
                                        </table>
                                    </div>
                                    <!-- /.info-box-content -->
                                ...
                                <div class="info-box info-box-new-style">
                                    ...
                                    <div class="info-box-content">
                                        ...
                                        <table >
                                            ...
                                            <tr>
                                                <td></span><span class="total-labels">الشهر : </span></td>
                                                <td><span class="info-box-number total_sell_month"><i class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span></td>
                                            </tr>
                                            <tr>
                                                <td></span><span class="total-labels">السنة  : </span></td>
                                                <td><span class="info-box-number total_sell_year"><i class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span></td>
                                            </tr>
                                        </table>
                                ...
                                <div class="info-box info-box-new-style">
                                    ...
                                    <div class="info-box-content">
                                        ...
                                        <table >
                                            ...
                                            <tr>
                                                <td></span><span class="total-labels">الشهر : </span></td>
                                                <td><span class="info-box-number purchase_due_month"><i class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span></td>
                                            </tr>
                                            <tr>
                                                <td></span><span class="total-labels">السنة  : </span></td>
                                                <td><span class="info-box-number purchase_due_year"><i class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span></td>
                                            </tr>
                                        </table>
                                    </div>
                                    <!-- /.info-box-content -->
                                ...
                                <div class="info-box info-box-new-style">
                                    ...
                                    <div class="info-box-content">
                                        ...
                                        <table >
                                            ...
                                            <tr>
                                                <td></span><span class="total-labels">الشهر : </span></td>
                                                <td><span class="info-box-number invoice_due_month"><i class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span></td>
                                            </tr>
                                            <tr>
                                                <td></span><span class="total-labels">السنة  : </span></td>
                                                <td><span class="info-box-number invoice_due_year"><i class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span></td>
                                            </tr>
                                        </table>
