			...
			<div class="modal-body">
				<div class="row">
					...
					<div style="margin: auto;max-width: 80%;text-align: center">
						<h2>@lang('lang_v1.card_payment_model')</h2>
					</div>
				</div>
			</div>

			<div class="modal-footer">
				<button type="button" class="btn btn-danger" id="pos-save-card">@lang('sale.finalize_payment')</button>
				<button type="button" class="btn btn-primary" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">@lang('messages.close')</span></button>
