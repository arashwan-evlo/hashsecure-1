	...
	<div class="{{$col_class}}">
		<div class="form-group">
			...
			<div class="input-group">
				...
				{!! Form::text("payment[$row_index][amount]", '', ['class' => 'form-control payment-amount input_number', 'required', 'id' => "amount_$row_index", 'placeholder' => __('sale.amount'), 'readonly' => $readonly]); !!}
			</div>
		</div>
	</div>
	@if(!empty($show_date))
