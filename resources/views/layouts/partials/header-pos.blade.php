...
@php
    ...
    $go_back_url = action('HomeController@index');
  ...
  <div class="row">
   ...
   {{--   <button title="@lang('lang_v1.calculator')" id="btnCalculator" type="button" class="btn btn-success btn-flat pull-right m-5 btn-xs mt-10 popover-default" data-toggle="popover" data-trigger="click" data-content='@include("layouts.partials.calculator")' data-html="true" data-placement="bottom">
      ...
      @endif
        ...
        @can('account.fund-transfer')
        <button data-href="{{action('AccountController@getFundTransfer',[1])}}" class="btn btn-danger btn-flat m-6 btn-xs m-5 pull-right btn-modal" data-container=".view_modal"><i class="fa fa-exchange"></i> @lang("account.fund_transfer")</button>
        @endcan
    <?php
