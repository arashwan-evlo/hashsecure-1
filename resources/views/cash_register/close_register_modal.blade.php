<div class="modal-dialog modal-lg" role="document">
  ...
  <div class="modal-content">
    ...
    <div class="modal-header">
      ...
      <h3 class="modal-title">@lang( 'cash_register.current_register' ) ( {{ \Carbon::createFromFormat('Y-m-d H:i:s', $register_details->open_time)->format('Y-m-d H:i') }} إلي  {{ \Carbon::now()->format('Y-m-d H:i') }})</h3>
    </div>
        ...
        <div class="col-sm-12">
          <table class="table">
            ...
            @if(array_key_exists('custom_pay_4', $payment_types))
                  @if($register_details->total_custom_pay_4 != 0)
                    <tr>
                <td>
            ...
            @if(array_key_exists('custom_pay_5', $payment_types))
                  @if($register_details->total_custom_pay_5 != 0)
                   <tr>
                <td>
            ...
            @if(array_key_exists('custom_pay_6', $payment_types))
                  @if($register_details->total_custom_pay_6 != 0)
                    <tr>
                <td>
            ...
            @if(array_key_exists('custom_pay_7', $payment_types))
                  @if($register_details->total_custom_pay_7 != 0)
                       <tr>
                <td>
                    ...
                    <tbody>
                        <tr class="success">
                          ...
                          اجمالي مدفوعات المشتريات</strong>
                            ...
                            <td>
                                <strong><span class="display_currency" data-currency_symbol="true">{{$purchases[0]->amount_paid}}</span></strong>
                            </td>
                        </tr>
                        <tr class="success">
                          <th>
                        ...
                        <tr class="success">
                              ...
                              <td><strong>
                                      <span class="display_currency" data-currency_symbol="true">{{$total_expences}}</span></strong>
                              </td>
    ...
    <div class="row">
        <div class="col-md-12" style="background-color: #760e0e">
            <h4><span style="color: white">التحويلات : </span>

             <span  class="display_currency" data-currency_symbol="true" style="color: white">
                 {{$fund_transfer['total_fund']}}
             </span></h4></div>

        <div class="col-md-12 success"><h4><span>المتبقي : </span><span  class="display_currency" data-currency_symbol="true">{{$total_in-$total_out}}</span></h4></div>
     <div class="col-md-12 success">
         <h4><span>درج النقدية : </span>
             <span  class="display_currency" data-currency_symbol="true">{{$total_in-$total_out-$register_details->total_card - $register_details->total_bank_transfer}}</span></h4></div>
