            ...
            <div class="row">
                ...
                <span class="input-group-addon">
                    <i class="fa fa-phone"></i>
                            ...
                            {!! Form::text('landline', $contact->landline, ['class' => 'form-control']); !!}
                        </div>
                    </div>
                </div>
                <div class="col-md-8">
                ...
                <div class="col-md-6  " id="sub_account_dev">
                    <div class="form-group ">
                        {!! Form::label('account_id','  الحساب الفرعي في قائمة الحسابات : ') !!}
                        {!! Form::select('account_id', $sub_accounts,$contact->account_id, ['class' => 'form-control select2 ', 'style' => 'width:100%', 'id' => 'account_id' ]); !!}
                ...
                <div id="more_div" class="hide">
                        ...
                        <div class="form-group">
                          ...
                          <span class="input-group-addon">
                              <i class="fa fa-info"></i>
                                ...
                                {!! Form::text('commercial_register',  $contact->commercial_register, ['class' => 'form-control', 'placeholder' => __('lang_v1.commercial_register')]); !!}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                  ...
                  <span class="input-group-addon">
                    ...
                    <div class="col-md-4 opening_balance">
                        <div class="form-group">
                            {!! Form::label('opening_balance_type','نوع الرصيد الإفتتاحي : ') !!}
                            <select class="form-control select2" name="opening_balance_type" style="width: 100%">
                                <option value="debit" @if($journal->type==='debit') selected @endif>مدين</option>
                                <option value="credit" @if($journal->type==='credit') selected @endif>دائن</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4  " >
                        <div class="form-group ">
                            ...
                            {!! Form::select('opening_balance_account_id', $sub_accounts,$opening_balance_account->account_id, ['class' => 'form-control select2 ', 'style' => 'width:100%', 'id' => 'account_id' ]); !!}
