            ...
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs nav-justified">
                    ...
                    @if(in_array($contact->type, ['both', 'supplier']))
                        <li class="
                            @if(!empty($view_type) &&  $view_type == 'purchase') active  @else '' @endif">
                    ...
                    <li class="
                            @if(!empty($view_type) &&  $view_type == 'payments')  active  @else '' @endif">
                    ...
                    @if( in_array($contact->type, ['customer', 'both']) && session('business.enable_rp'))
                        <li class="
                            @if(!empty($view_type) &&  $view_type == 'reward_point') active  @else '' @endif">
                ...
                <div class="tab-content">
                    <div class="tab-pane
                                @if(!empty($view_type) &&  $view_type == 'ledger') active  @else ''  @endif"  id="ledger_tab">
