			...
			<table class="table table-condensed text-right align-right table-bordered  @if(empty($for_pdf)) table-pdf @endif">
				...
				@if( $contact->type == 'supplier' || $contact->type == 'both')
					<tr>
						...
						<td class="align-right">@format_currency($ledger_details['total_purchase']){{--( <strong><span style="color:#8f2323;"> @lang('account.credit')</span></strong>)--}}</td>
					</tr>
				@endif
				...
				<tr>
					...
					<td class="align-right">@format_currency($ledger_details['total_paid']) {{--( <strong><span style="color:#8f2323;"> @lang('account.debit')</span></strong>)--}}</td>
				</tr>
				@if($contact->balance>10)
				{{--<tr>
					<td class="align-right">@lang('lang_v1.advance_balance')xxxx</td>
