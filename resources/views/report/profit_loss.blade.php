...
<script type="text/javascript">
    $(document).ready( function() {
        ...
        profit_by_products_table = $('#profit_by_products_table').DataTable({
                ...
                serverSide: true,
                "ajax": {
                    "url": "/reports/get-profit/byproduct",
                    "data": function ( d ) {
                        ...
                        d.location=$('#profit_loss_location_filter').val();
                    }
                },
                columns: [
                    { data: 'product', name: 'p.name'  },
                    { data: 'unit_price_inc_tax', "searchable": false},
        ...
        $('#profit_tabs_filter').on('change',function(){
            profit_by_products_table.ajax.reload();
        });
