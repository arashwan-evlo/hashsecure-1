      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            {!! Form::file('logo', ['id' => 'upload_image', 'accept' => 'image/*']); !!}
            <small><p class="help-block">@lang('lang_v1.invoice_logo_help', ['max_size' => '1 MB']) </p></small>
            <img width="100" src="/uploads/invoice_logos/{{$invoice_layout->logo}}">
          </div>
        </div>
     ...
     <div class="clearfix"></div>
        <div class="col-sm-3 hidden">
          <div class="form-group">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('show_landmark', 1, 0, ['class' => 'input-icheck']); !!} @lang('business.landmark')</label>
              </div>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('show_city', 1, $invoice_layout->show_city, ['class' => 'input-icheck']); !!} عرض عنوان الفرع</label>
              </div>
          </div>
        </div>
        <div class="col-sm-3 hidden">
          <div class="form-group">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('show_state', 1, 0, ['class' => 'input-icheck']); !!} @lang('business.state')</label>
              </div>
          </div>
        </div>
        <div class="col-sm-3 hidden">
          <div class="form-group">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('show_country', 1, 0, ['class' => 'input-icheck']); !!} @lang('business.country')</label>
              </div>
          </div>
        </div>
        <div class="col-sm-3 hidden">
          <div class="form-group">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('show_zip_code', 1, 0, ['class' => 'input-icheck']); !!} @lang('business.zip_code')</label>
              </div>
          </div>
        </div>
        <div class="clearfix"></div>
      ...
      <div class="row">
        ...
        <div class="col-md-12 hide">
          <hr/>
           ...
           <div class="col-md-12">
             <h3>@lang('invoice.footer_text')</h3>
           </div>
          <div class="col-sm-3">
            <div class="form-group">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('show_shipping', 1, $invoice_layout->show_shipping, ['class' => 'input-icheck']); !!} @lang('invoice.show_shipping')</label>
              <br>
              </div>
            </div>
          </div>
...
<script type="text/javascript">
    ...
    __page_leave_confirmation('#add_invoice_layout_form');</script>
@endsection