    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <br>
                  <label>
                    {!! Form::checkbox('pos_settings[disable_draft]', 1,  $pos_settings['disable_draft'] ,
                ...
                <div class="checkbox">
                    ...
                    <label>
                        {!! Form::checkbox('pos_settings[disable_shipping]', 1,
                           !empty($pos_settings['disable_shipping'])? $pos_settings['disable_shipping']:0,
                        [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.disable_shipping' ) }}
                    </label>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <div class="checkbox">
                    <br>
                    <label>
                        {!! Form::checkbox('pos_settings[disable_checkout_card_button]', 1,
                        empty($pos_settings['disable_checkout_card_button']) ? 0 : 1 ,
                        [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.disable_checkout_card_button' ) }}
                    </label>
                </div>
            </div>
        </div>
